...
const bg: Dictionary = {
  ...
  destinations: {
    ...
    pageDescription:
      "Локални бележки, които decide вече има за тези {count} града - реални разходи, как да се придвижвате и какво да пропуснете - преди изобщо да се направи търсене на живо.",
    notOnListNote: "Няма я в списъка? decide планира навсякъде - това са само отправна точка.",
    localNotesCount: "{count} локални бележки",
