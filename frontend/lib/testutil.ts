...
//
// A copy of worker/src/testutil.ts rather than an import across the two
// packages: they install separately and deploy to different hosts, the
// same reason facts/ is copied instead of imported. Thirty lines of
// "did this hold" is a cheaper duplication than a cross-package
// dependency, and this file has no reason to change.
